...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nitropay.conf'
CONFIGFOLDER='/root/.nitropaycore'
COIN_DAEMON='nitropayd'
COIN_CLI='nitropay-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/nitropay/nitro/releases/download/v.0.12.2/nitropaycore-0.12.2-linux64.tar.gz'
